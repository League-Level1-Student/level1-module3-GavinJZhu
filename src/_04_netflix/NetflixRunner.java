...
public static void main(String[] args) {
	Movie movie1 = new Movie("Why your mom is fat", 5);
	Movie movie2 = new Movie("Why your docter diagnosed you with chronic depression", 16);
	Movie movie3 = new Movie("Why you are schizophrenic", 14);
	Movie movie4 = new Movie("You are depressed", 100000);
	Movie movie5 = new Movie("Why your father left you",69);
